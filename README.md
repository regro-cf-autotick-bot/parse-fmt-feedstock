...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parse-fmt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14761&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parse-fmt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parse-fmt` can be installed with:

```
conda install parse-fmt
```

It is possible to list all of the versions of `parse-fmt` available on your platform with:
